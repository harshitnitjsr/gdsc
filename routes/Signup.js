...
router.post("/signup", async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `Someone with the name :  ${name} and Email id : ${email} just registered on the GDSC Admin portal.<br> Click here https://gdsc-ten.vercel.app/api/v1/verify/${verificationToken} to verify ${name}.`
    };
